...
ninja.data = [
  {
    ...
    section: "Sections",
    handler: () => {
      window.location.href = "{{ '/' | relative_url }}#about";
    },
  },
  {
    ...
    section: "Sections",
    handler: () => {
      window.location.href = "{{ '/' | relative_url }}#experience";
    },
  },
  {
    id: "section-projects",
    ...
    section: "Sections",
    handler: () => {
      window.location.href = "{{ '/' | relative_url }}#projects";
    },
  },
  {
  ...
  {
    id: "section-currently-reading",
    title: "Currently reading",
    section: "Sections",
    handler: () => {
      window.location.href = "{{ '/' | relative_url }}#currently-reading";
    },
  },
  {%- endif -%}
